...
<div id="main">
  <div class="shell_package_updown">
	  <div class="two-col">
	    <h1><font><strong>Register new Appointment</strong></font></h1>
	   
	   <!-- <h2>Register new student</h2>-->
        <form id="form1" name="form1" method="post" action="AddAppointmentSevlet" onsubmit="return validation();">
	    <table width="639" border="0">
	      ...
	      <tr>
	        <td height="32"><div align="right">Appointment ID</div></td>
	        <td>&nbsp;</td>
	        <td><label for="txtDrugName2" >
	          <input name="appointmentId" type="text" id="appointmentId" size="45" />
	        </label></td>
	        <td>&nbsp;</td>
          </tr>
	     
	      <tr>
	        <td width="117" height="32"><div align="right">Job Id</div></td>
	        <td width="10">&nbsp;</td>
	      ...
	      <tr>
	        	        <td height="32"><div align="right">Appointment Date</div></td>
	        <td>&nbsp;</td>
	        <td><input name="appointmentDate" type="text" id="appointmentDate" size="45" /></td>
	        <td>&nbsp;</td>
          </tr>
          <tr>
	        < <tr>
	        	        <td height="32"><div align="right">Appointment Time</div></td>
	        <td>&nbsp;</td>
	        <td><input name="appointmentTime" type="text" id="appointmentTime" size="45" /></td>
	        <td>&nbsp;</td>
          </tr>
          </tr>
           <tr>
