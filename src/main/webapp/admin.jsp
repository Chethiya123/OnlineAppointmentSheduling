			...
			<div id="apDiv1"><ul>
				   ...
				   <!-- <li><a href="about.html"><span>About Us</span></a></li>
				    <li><a href="login.html"><span>Login</span></a>-->
                     <li><a href="addNewStudent.jsp"><span><button class="button">Register Consultant</button></span></a>                                   
			</ul>
			  <ul>
			    <li><a href="viewAppointment.jsp"><span><button class="button">View  Appointments</button></span></a>                     
		      </ul>
			  <ul>
			    <li><a href="viewConsultants.jsp"><span><button class="button">View Consultants</button></span></a>                
			   </ul>
                            
                            <ul>
			    <li><a href="viewJobSeeker.jsp"><span><button class="button">View Job Applicants</button></span></a>                
			   </ul>
			  <ul>
...
<div id="main">
  <div class="shell_package_updown">
	  <div class="two-col">
	    <h1><font><strong>Welcome Course Admin</strong></font></h1>
